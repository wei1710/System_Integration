...
@router.get('/api/spacecrafts/{spacecraft_id}', tags=['spacecraft'], response_class=Spacecraft)
...
@router.post('/api/spacecrafts', tags=['spacecraft'], response_class=Spacecraft)
